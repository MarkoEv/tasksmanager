  ...
  return (
    <div className="col-span-1">
      <div className="fixed bottom-4 left-1/2 z-50 w-[90%] -translate-x-1/2 md:hidden">
        <div className="flex items-center justify-between rounded-2xl border border-white/10 bg-white/5 px-4 py-3 shadow-lg backdrop-blur-md">
          <button
            onClick={() => setOpenModal(true)}
            className="flex flex-col items-center text-green-400 transition-all active:scale-90"
          >
